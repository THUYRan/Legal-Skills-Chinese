...
> 说明：此文件在保持原始 `SKILL.md` 内容完全不变的前提下，提供一个标准化的顶部说明和概述，便于审阅后再决定是否替换原文件。
...
|------|------|
| **能力名称** | 争议焦点识别 |
| **来源文件** | `SKILL.md`（原始内容完全保留） |
| **说明** | 本文件在顶部增加结构化概述，下方完整包含原始 `SKILL.md` 的内容，未对原文做任何删改。 |

---

## 原始内容（完整保留）

下面为 `SKILL.md` 的完整原文，未经修改：
...
- Capability 1 从案件材料中识别争议问题
- Capability 2 判断哪些争议属于事实争议、哪些属于法律争议
- Capability 3 将零散内容转化为法律问题，为后续分析提供基础
